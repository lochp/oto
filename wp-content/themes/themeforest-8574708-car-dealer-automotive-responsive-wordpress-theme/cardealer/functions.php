		...
		return array(
			...
			*/
			...
			array(
				...
				'source'             => 'https://github.com/ThemeMakers/tmm_theme_features/archive/cardealer_v1.0.6.zip',
				'required'           => true,
			...
			array(
				...
				'source'             => 'https://github.com/ThemeMakers/tmm_content_composer/archive/cardealer_v1.2.16.zip',
				'required'           => true,
				'version'           => '1.2.16',
			),
			array(
				...
				'source'             => 'https://github.com/ThemeMakers/tmm_paypal_checkout/archive/cardealer_v1.1.5.zip',
				'required'           => false,
				'version'           => '1.1.5',
			),
			array(
				'name'               => 'LayerSlider',
				'slug'               => 'LayerSlider',
				'source'             => 'http://plugins.webtemplatemasters.com/plugins/cardealer/LayerSlider-ls-cardealer_v5.6.6.zip',
				'required'           => false,
				'version'           => '5.6.6',
			),
			array(

					...
					<p>
						...
						<select <?php if ( $required_car_features['car_state'] == '1' ) {
							...
							foreach ($condition_list as $cond_id => $cond_name) {
								echo '<option value="'.$cond_id.'"' . selected($condition, $cond_id, false) . '>' . $cond_name . '</option>';
							} ?>
						</select>
					</p>
						...
						<div class="col-md-6">
							...
							<p>
								...
								<label for="car_engine_size">
									<strong><?php _e( 'Engine Size', 'cardealer' ); ?> (<?php echo tmm_get_car_engine_unit() ?>)</strong>
								</label>
